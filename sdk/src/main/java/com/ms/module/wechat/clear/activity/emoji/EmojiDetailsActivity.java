...
import com.ms.module.wechat.clear.activity.image.ImageAdapter;
...
public class EmojiDetailsActivity extends BaseAppCompatActivity implements RxView.Action1<View> {
    ...
    private static EmojiDetailsActivity instance;

    public static EmojiDetailsActivity getInstance() {
        return instance;
    }
        ...
        if (view.getId() == R.id.imageViewBack) {
            ...
            DialogDelete.show(this, new DialogDelete.Call() {
                ...
                public void onDelete() {
                    ...
                    WeChatClearModule.getWeChatClearCallBack().onDeleteFile(EmojiDetailsActivity.this, filesLength);
